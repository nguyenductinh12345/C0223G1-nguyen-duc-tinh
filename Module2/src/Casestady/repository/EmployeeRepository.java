...
public class EmployeeRepository implements IEmployeeRepository {
    ...
    public void editEmployee() {
        readerAndWrite.writeFile("/Users/user/Documents/C0223G1-nguyen-duc-tinh/Module2/src/Casestady/data/Employee.csv"
                , employeeList);
    }

    public int checkCMND(String cmnd) {
        employeeList=readerAndWrite.readFile
                ("/Users/user/Documents/C0223G1-nguyen-duc-tinh/Module2/src/Casestady/data/Employee.csv");
    ...
    public int timKiem(String cmnd){
        employeeList=readerAndWrite.readFile
                ("/Users/user/Documents/C0223G1-nguyen-duc-tinh/Module2/src/Casestady/data/Employee.csv");
        for (int i = 0; i < employeeList.size(); i++) {
            if (cmnd.equals(employeeList.get(i).getSoCMND())){
